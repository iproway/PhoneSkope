...
@implementation PSFaceDetection
...
- (void)grepFacesForSampleBuffer:(CMSampleBufferRef)sampleBuffer{
    ...
    AVCaptureDevicePosition currentCameraPosition = [_videoCamera cameraPosition];
    ...
    NSLog(@"Face Detector %@", [faceDetector description]);
